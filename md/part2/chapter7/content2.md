...
在表示“命令、要求、建议”等含义的名词之后所接的主语从句、表语从句或同位语从句，需要使用虚拟语气，谓语动词的形式为`(should) + do`
...
- `should have done|ought to have done`：本来应该做某事，但实际上没做
    ...
    2. I **ought to have watched** that movie because it gave me horrible dreams.
